...
test('renders CourseCard correctly', () => {
	...
	expect(screen.queryByTestId('course-duration').textContent).toBe('160 hours');
	expect(screen.queryByTestId('course-authors').textContent).toBe('12');
	expect(screen.queryByTestId('course-creation-date').textContent).toBe('8/3/2021');
});
